...
user3 = User.create!({ email: 'william_peters@gmail.com', password_digest: BCrypt::Password.create('1234'), admin: false, name: "William Peters", profession: "Retail", marital_status: "Married", hiv: false, veteran: true, immigrant: "citizen", age: 42, gender: "male", picture: "a.jpg"})
...
user27 = User.create!({ email: 'david_william Brown@gmail.com', password_digest: BCrypt::Password.create('1234'), admin: false, name: " David William Brown", profession: "Retail", marital_status: "Married", hiv: false, veteran: false, immigrant: "permanent resident", age: 77, gender: "male"})
